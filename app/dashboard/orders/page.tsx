    ...
    return (
        <Card>
            <CardHeader>
                ...
                <CardDescription>Check the status of your
                    orders</CardDescription>
            </CardHeader>
            <CardContent>
                <Table>
                    ...
                    <TableBody>
                        {userOrders.map((order) => (
                            <TableRow key={order.id}>
                                ...
                                <TableCell>A${order.total}</TableCell>
                                <TableCell>
                                    <Badge
                                        className={
                                    ...
                                    <Dialog>
                                            ...
                                            <DropdownMenuContent>
                                                <DropdownMenuItem>
                                                    <DialogTrigger asChild>
                                                        <Button className="w-fu1l" variant={"ghost"}>
                                                            View Details
                                                        </Button>
                                                    </DialogTrigger>
                                                </DropdownMenuItem>
                                                {order.receiptURL ? (
                                                    <DropdownMenuItem>
                                                        <Button
                                                            ...
                                                            className="w-fu11"
                                                            variant={"ghost"}>
                                                            <Link href={order.receiptURL} target="blank">
                                                                Download Receipt
                                                            </Link>
                                                        </Button>
                                                    </DropdownMenuItem>
                                        ...
                                        <DialogContent className="rounded-md">
                                            <DialogHeader>
                                                ...
                                                <DialogDescription>
                                                    Your order total is A${order.total}
                                                </DialogDescription>
                                            </DialogHeader>
